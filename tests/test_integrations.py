...
class TestGovmapClient:
    """Tests for Govmap client (Phase 3 manual fallback)."""

    @pytest.fixture()
    def client(self) -> GovmapClient:
        return GovmapClient()

    async def test_not_available_in_phase3(self, client: GovmapClient) -> None:
        """Govmap returns unavailable in Phase 3."""
        assert client.is_available() is False

    async def test_get_tabas_returns_none(self, client: GovmapClient) -> None:
        """Returns None for manual input in Phase 3."""
