...
/** Common moshavim / agricultural settlements for datalist suggestions */
const MOSHAV_SUGGESTIONS = [
  "נהלל", "כפר יהושע", "מרחביה", "עין חרוד", "גבע", "בית אלפא",
  "דגניה א'", "דגניה ב'", "כנרת", "כפר תבור", "שדה יעקב", "בלפוריה",
  "כפר ברוך", "כפר גדעון", "כפר גליקסון", "כפר הרואה", "כפר חסידים",
  "כפר יהזקאל", "כפר מל\"ל", "כפר נטר", "כפר סירקין", "כפר ויתקין",
  "כפר ורבורג", "כפר מונש", "כפר הס", "כפר בן נון", "כפר ביל\"ו",
  "נחלת יהודה", "גן יאשיה", "בית חרות", "עין ורד", "גבעת עדה",
  "בניאמינה", "פרדס חנה", "זכרון יעקב", "עתלית", "דלית אל כרמל",
  "יקנעם", "רמת ישי", "כפר חיטין", "מגדל", "ראש פינה", "יסוד המעלה",
  "משמר הירדן", "חצור הגלילית", "כפר סאלד", "אילניה", "כפר תקווה",
  "בית שערים", "ניר עציון", "בת שלמה", "גבעת ניל\"י", "בנימינה",
  "אביחיל", "נורדיה", "כפר יונה", "חדרה", "פרדסיה", "הוד השרון",
  "מגדיאל", "רעננה", "כפר שמריהו", "הרצליה", "ראשון לציון",
  "נס ציונה", "רחובות", "גדרה", "באר טוביה", "קסטינה",
  "ניר בנים", "עזריקם", "נגבה", "גבעתי", "יד מרדכי",
  "ניר עוז", "כרם שלום", "נתיב העשרה", "שדרות", "אופקים",
  "נתיבות", "ערד", "ירוחם", "מצפה רמון", "באר שבע",
  "להבים", "מיתר", "כרמל", "עומר", "שגב שלום",
  "אשכלון", "אשדוד", "יבנה", "גן יבנה", "קרית מלאכי",
  "קרית גת", "לכיש", "אמציה", "בית גוברין", "תל לכיש",
  "מושב ברקאי", "מנשה", "להבות הבשן", "מבוא חמה", "חד נס",
  "רמת מגשימים", "אלוני הבשן", "קצרין", "אניעם", "נאות גולן",
];
  ...
  return (
    <div className="space-y-6">
      <TextInput
        ...
        required
        datalistOptions={MOSHAV_SUGGESTIONS}
