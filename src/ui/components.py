...
async def display_intake_form() -> None:
    ...
    form_text = (
        ...
        "| 8 | מטרות הלקוח (client_goals) | רשימה | regularization / capitalization / split / all |\n"
        "| 9 | רצף בין-דורי (has_intergenerational_continuity) | כן/לא | true / false |\n"
        "| 10 | מבנה בעלות (ownership_type) | בחירה | single / partners / heirs |\n"
        "| 11 | צווי הריסה (has_demolition_orders) | כן/לא | true / false |\n\n"
